...
export class DrawTabComponent {
  ...
  readonly tools: DrawTool[] = [
    { id: 'marker',       label: 'Marcador',   icon: 'room',                tooltip: 'Colocar un marcador',    description: 'Punto de interés' },
    { id: 'polyline',     label: 'Línea',       icon: 'timeline',            tooltip: 'Dibujar una línea',      description: 'Camino o ruta'    },
    { id: 'polygon',      label: 'Polígono',    icon: 'hexagon',             tooltip: 'Dibujar un polígono',    description: 'Área cerrada'     },
    { id: 'rectangle',    label: 'Rectángulo',  icon: 'rectangle',           tooltip: 'Dibujar un rectángulo',  description: 'Zona cuadrada'    },
    { id: 'circle',       label: 'Círculo',     icon: 'circle',              tooltip: 'Dibujar un círculo',     description: 'Área circular'    },
    { id: 'circlemarker', label: 'Punto',       icon: 'fiber_manual_record', tooltip: 'Colocar un punto fijo',  description: 'Punto pequeño'    },
  ];
